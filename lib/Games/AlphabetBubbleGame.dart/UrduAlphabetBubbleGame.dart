...
import 'package:alphabetgame/Games/AlphabetBubbleGame.dart/BubbleGameWidgets/urduAplhabetBubble.dart';
import 'package:lottie/lottie.dart';

class UrduAlphabetBubbleGame extends StatefulWidget {
  UrduAlphabetBubbleGame({Key key}) : super(key: key);

  @override
  _UrduAlphabetBubbleGameState createState() => _UrduAlphabetBubbleGameState();
}

class _UrduAlphabetBubbleGameState extends State<UrduAlphabetBubbleGame> {
  List<int> aphaint = [
    1,
    2,
    3,
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        floatingActionButton: initialDialogue
            ? Container()
            : Row(
                children: [
                  SizedBox(
                  ...
                  FloatingActionButton(
                    ...
                    child: Container(
                      ...
                      child: Center(
                          child: Image.asset(
                        "assets/urduAlphabets/${currentIndex > 35 ? 35 : currentIndex}.jpg",
                        height: 40,
                      )),
                    ),
                    onPressed: () {},
                      ...
                      child: Align(
                          ...
                          child: InkWell(
                              ...
                              child: Lottie.network(
                                  "https://assets4.lottiefiles.com/packages/lf20_T0oGsn.json",
                                  height: 220))),
                    ),
                    Padding(
